...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery("select#sel-department").append(jQuery("<option></option>").attr("value", "all").text("All Departments"));
        jQuery.each(department_locations, function(k, v) {
            locCnt = department_locations[k].length;
            jQuery("select#sel-department").append(jQuery("<option></option>").attr("value", k).text(k));
        })

        // fill locations select (all locations at first)
        jQuery("select#sel-location").empty();
        jQuery("select#sel-location").append(jQuery("<option></option>").attr("value", "all").text("All Locations"));
...
<div id="job-openings-wrap">
    <div class="job-openings-inner">
        ...
        <div class="job-openings-filters">
            ...
            <div class="job-openings-filter">                
                <select id="sel-department" placeholder="department">
                </select>
            </div>
...
<div class="comeet-outer-wrapper">
    ...
    ?>
        <div id="ox-comeet-position-list" class="comeet-groups-list">
            <?php
            foreach ($comeet_groups as $category) {
            ?>
                <div class="comeet-g-r" data-department="<?= $category ?>">
                    <?php /*
                    //cmg: no need to show title for each department
                                ...
                                ?>
                                                <li class="comeet-position" data-location="<?= $post['location']['name'] ?>">
                                                    <a href="<?= $href ?>">
                                                        ...
                                                        <div class="ox-comeet-position-meta department">
                                                            <?php echo $post['department']; ?>
                                                        </div>

                                                        <div class="ox-comeet-position-meta location">
